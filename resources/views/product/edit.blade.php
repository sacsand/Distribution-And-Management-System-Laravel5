    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <h1>Update {{$product->name}} details</h1>

                <hr/>
                {!! Form::model($product,['method' => 'PATCH','action'=>['ProductController@update',$product->id],'class' => 'form-horizontal','id' =>'register-form']) !!}
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {!! Form::text('productId',null,['class' => 'form-control','readonly' => 'true']) !!}
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-sm-12">
                        {!! Form::submit('Update Product',['class' =>'btn btn-danger form-control']) !!}
                    </div>
                </div>
